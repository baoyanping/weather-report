			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="<%=request.getContextPath()%>/admin/editKnows" id="editfrom" method="post">
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      <input type="text" class="form-control" id="inputPassword3" name="title" placeholder="请输入标题" value="${knows.title}">
							    </div>
							  </div>
							<div class="form-group">
								<label for="inputPassword1" class="col-sm-2 control-label">内容</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputPassword1" name="content" placeholder="请输入内容" value="${knows.content}">
								</div>
							</div>
